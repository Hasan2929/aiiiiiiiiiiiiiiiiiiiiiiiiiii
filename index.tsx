...
document.addEventListener('DOMContentLoaded', () => {
    ...
    generateButton.addEventListener('click', async () => {
        ...
        try {
            ...
            const prompt = "Animate this product image with a cinematic, slow-motion, elegant swirling smoke and vapor effect, like a luxury perfume advertisement. The background should be dark and moody. The animation should be a short, looping video.";
